...
import { IoPerson, IoCheckmarkCircle, IoRadioButtonOn, IoRadioButtonOff, IoNotificationsOutline } from 'react-icons/io5';
...
function Inicio() {
  ...
  // Funções para mostrar/ocultar o LeftSidebar
  ...
  return (
    <div className="app-container">
      <header className="app-header">
        <Menu 
          ...
          <div className='bm-papeis'>
            ...
            <div>
              <div className='bm-linhas-papel'><IoRadioButtonOn/><span className='bm-info'>Colaborador</span></div>
              <span className='bm-info2'>Divisão de Tecnologia</span>
            </div>
            <div>
            <div className='bm-linhas-papel'><IoRadioButtonOff/><span className='bm-info'>Gestor</span></div>
        ...
        <Menu 
          ...
          // isOpen={true}
          noOverlay
          customBurgerIcon={<div className="notification-icon">
      ...
      <main className="app-main">
        ...
        <div className="calendar-container"> {/* Container para centralizar o calendário */}
          <Calendario/> {/* Adicione o componente do calendário aqui */}
        </div>
      </main>
